...
def main():
    ...
    ulog = ubkgLogging(log_dir=log_dir, log_file='skowlnets.log')
    ...
    cfgpath = os.path.join(os.path.dirname(os.getcwd()), 'generation_framework/translators/simpleknowledge2edgenode/simpleknowledge2edgenode.ini')
