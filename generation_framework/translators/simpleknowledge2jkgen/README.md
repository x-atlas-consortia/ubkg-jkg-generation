...
# Content
- **simpleknowledge2jkgen.py** - Does the following:
...
- **simpleknowledge2jkgen.ini.example** - Annotated example of an ini file.

# Configuration file and SimpleKnowledge source spreadsheets
The SimpleKnowledge spreadsheets that **simpleknowledge2jkgen.py** uses are located in the **scr** folder of the [SimpleKnowledge](https://github.com/x-atlas-consortia/SimpleKnowledge/tree/main) GitHub repository.
...
# To run
1. Copy and modify **simpleknowledge2jkgen.ini.example** to a file named **simpleknowledge2jkgen.ini** in the current directory.
2. Configure the **sources.json** file at the generation_framework root to call simpleknowledge2jkgen.py with the appropriate SAB.
